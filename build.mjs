...
.ftab{flex:0 0 auto;font-size:13px;font-weight:600;color:var(--mut);padding:11px 2px;cursor:pointer;white-space:nowrap;border-bottom:2px solid transparent;margin-bottom:-1px}
