...
function renderSummary(){
  ...
  if(prio.length){
    ...
    const dlcsv=el('button','dlbtn','⬇ CSV'); dlcsv.title='Download the critical & high issues as a spreadsheet';
    ...
    const dlpdf=el('button','dlbtn','🖨 PDF'); dlpdf.title='Open a printable view — save as PDF';
