...
function openPrio(it){var box=document.getElementById('dlgbox');
  ...
  var _abs=findAbs(it);
  var _share='<div class="dlg-share"><a class="dlbtn" href="#/'+flowPath(it)+'" onclick="_closeDlg()">↗ Open this page</a><button class="dlbtn" onclick="_copyLink('+"'"+_abs.replace(/'/g,"\\'")+"'"+',this)">🔗 Copy link</button></div>';
